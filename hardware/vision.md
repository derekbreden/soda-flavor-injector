...
8. **Print both and verify strut alignment** — hold them together by hand. Verify the 4 strut positions on the lever line up with the 4 strut positions on the release plate.
...
9. **Redesign coupler tray layout to 1×4** — all four couplers in a single row. This creates a clean split line between couplers 2 and 3.
10. **Redesign release plate bore pattern to 1×4** — match the coupler tray's new layout so the collet interfaces align.
11. **Print both and verify alignment** — hold them together by hand. Verify the release plate's bores line up with the coupler tray's couplers.
...
13. **Add strut bores to coupler tray** — same. The bores must be positioned so they don't interfere with the coupler pockets.
14. **Full interior dry fit** — lever + struts + release plate, passing through pump tray and coupler tray. Everything held in alignment by the bores. Verify the mechanism translates smoothly with all interior plates present. Nothing is joined — just stacked and held by hand.

#### Phase 5: Split the coupler tray

15. **Split coupler tray into two halves** — split between couplers 2 and 3 (the natural midpoint of the 1×4 line). Produce two STEP files. Plain flat mating faces at the split — no dovetail geometry.
16. **Print and test the split** — verify couplers can be inserted into each half, verify the two halves sit together and the shoulders provide axial retention. The halves are just held together by hand or gravity — no permanent join yet.
...
23. **Print all 6 panels and slide them together** — verify everything fits the rails. Nothing locks. Panels may slide back out. That's fine.
24. **Slide interior plates into the assembled box** — verify pump tray and coupler tray fit their rails.
25. **Full assembly dry fit** — everything together for the first time. Interior mechanism, interior plates, all 6 walls. Identify what doesn't fit, what binds, what needs clearance.

#### Phase 8: Refine panel holes

26. **Refine front panel hole** — after dry fit, adjust hole position and size so the user's fingers actually reach the lever comfortably. This may take multiple prints.
27. **Refine back panel holes** — after dry fit, verify tube stubs actually pass through and reach the quick connects.
...
28. **Add dovetail geometry to coupler tray halves** — the tapered dovetail slide that joins the two halves along the split line.
29. **Print and test the dovetail fit** — the halves slide together and hold by friction. No snap detent yet.

#### Phase 10: Coupler tray snap detent

30. **Add snap detent to coupler tray halves** — the prong barbs that lock the halves permanently at end of travel.
31. **Print and test the snap** — the halves click together and do not come apart.

#### Phase 11: Strut dovetail

32. **Add dovetail geometry to lever strut ends** — the male dovetail tongue on each strut.
33. **Add dovetail geometry to release plate strut ends** — the female dovetail channel on each strut.
34. **Print and test the dovetail fit** — lever struts slide into release plate struts and hold by friction. No snap detent yet.

#### Phase 12: Strut snap detent

35. **Add snap detent to strut dovetail joints** — the prong barbs that lock the strut joints permanently.
36. **Print and test the snap** — struts click together and do not come apart.
37. **Full mechanism test** — lever + struts + release plate, joined by the strut dovetails, passing through both interior plates. Verify the full mechanism translates and presses the collets.

#### Phase 13: Wall-to-wall dovetails

38. **Add dovetail geometry to left wall rails** — tapered dovetails on the rails so the front, back, bottom, and top panels lock along the slide axis.
39. **Add matching dovetail geometry to front, back, bottom, top panels** — the receiving features.
40. **Print and test the dovetail fit** — panels slide in and hold by friction. No snap detent yet.

#### Phase 14: Wall-to-wall snap detents

41. **Add snap detent to wall rail dovetails** — the features that lock panels at end of travel.
42. **Print and test wall retention** — panels click in, don't slide back out. Iterate on tolerances.

#### Phase 15: Interior plate dovetails

43. **Add dovetail geometry to interior plate rails** — pump tray and coupler tray lock along the slide axis in the side wall rails.
44. **Print and test the dovetail fit.**

#### Phase 16: Interior plate snap detents

45. **Add snap detent to interior plate rail dovetails.**
46. **Print and test interior plate retention.**
...
47. **Add bosses around strut bores in pump tray** — reinforce the bores now that we know the exact strut dimensions and clearances from prototyping.
48. **Add bosses around strut bores in coupler tray** — same.
49. **Print and test mechanism with bosses** — verify the added material doesn't bind the struts.

#### Phase 18: Cosmetics and UX

50. **Front panel exterior surface treatment** — the palm-push surface the user touches. Texture, radii, visual design.
51. **Lever surface treatment** — the finger-pull surface. Smooth or lightly textured for finger comfort.
52. **Side wall exterior surface treatment** — the surfaces visible when the cartridge is partially ejected from the enclosure.

#### Phase 19: Exterior tracks

53. **Add exterior protruding tracks to side walls** — the tracks that ride in the enclosure bay channels.
54. **Print and test track fit** — smooth sliding, correct clearances.

#### Phase 20: Spring return and final mechanism tuning

55. **Add spring pockets** — wherever the return springs end up living (TBD based on interior plate positions and available space).
56. **Tune squeeze force** — adjust spring rate, strut friction, bore clearances so the squeeze feels right.
57. **Final full assembly test** — everything together, mechanism works, panels locked, cartridge slides in and out of enclosure bay (once the enclosure bay exists).
